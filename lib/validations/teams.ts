...
export const createTeamSchema = z.object({
  ...
  teamImage: z.string().url("Team image must be a valid URL").optional(), // React Native uses URI strings
})
.strict()
.refine(
  (data) => {
...
export const updateTeamSchema = z.object({
  ...
  teamImage: z.string().url("Team image must be a valid URL").optional(),
}).strict();
